...
class SPT(nn.Module):
    def __init__(self, *, dim, patch_size, channels=3, image_size):
        super().__init__()
        patch_dim = dim * 5

        self.to_patch_tokens = nn.Sequential(
            Rearrange('b c h w  -> b (h w) c', h=image_size//patch_size, w=image_size//patch_size),
    ...
    def forward(self, x):
        ...
        shifts = ((4, -4, 0, 0), (-4, 4, 0, 0), (0, 0, 4, -4), (0, 0, -4, 4))
